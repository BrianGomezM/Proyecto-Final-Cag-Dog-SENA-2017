<?php
	...
	if (isset($_GET['id_despa']))
	{
		$id_despa=$_GET['id_despa'];
		$editar=$_GET['editar'];
		$sql="SELECT desparacitacion.fecha, propietario.numero_tipo,  propietario.p_nombre, propietario.s_nombre, propietario.p_apellido, propietario.s_apellido, propietario.celular, mascota.nombre, especie.especie , mascota.raza, mascota.fecha_nacimiento,  desparacitacion.actividad FROM desparacitacion, propietario, mascota, especie WHERE desparacitacion.id_despa='$id_despa' AND desparacitacion.id_mascota = mascota.id_mascota AND mascota.id_especie = especie.id_especie AND mascota.id_propietario = propietario.id_propietario";
	...
	{
		$id=$_GET['mas'];
		$slq2="SELECT especie.especie , mascota.raza, DATEDIFF(fecha_actu,fecha_nacimiento) FROM mascota,especie
...
tr:hover td { background: #d0dafd; color: #339; }
	...
	<table >
        <div class="contenedor">
            <form action="boton_despa.php" method="POST" name="descargar">       
            
					<tr>
						<td class="jv" colspan="5">&nbsp;Fecha:&nbsp;&nbsp;
<input type="date" name="fecha"  title="fecha" required style="width:140px" <?php if(isset($fecha)){echo "value='".$fecha."'";}?><?php if(isset($row4[0])){echo "value='".$row4[0]."'";}?>/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label class="letras" > REGISTRAR DESPARASITACION</label></td>
					</tr>
					<tr>
                ...
                <tr>
					...
					<tr>
						...
						<td>
							<input type="text" style="width:170px" readonly="readonly" title="Fecha Nacimiento" 
							<?php if (isset($row2['2'])){echo "value='".$row2['2'].$tiempo."'";}  ?>
                                                          <?php if(isset($row4[12])){echo "value='".$row4[12]."'";}?>
                                                        />
						</td>
						
						<td ><select name="vtt" id="vtt" style="width:140px" >
						...
						<tr>
							...
							<tr>
								<td colspan="5">
								<textarea name="motivos" style="width:870px" class=estilotextarea id="motivos" rows="1" cols="98"></textarea
								</td>
							</tr>
						</tr>
					</tr>
			...
			<td colspan="2" align="right"><input type="hidden" name="id_despa" id="id_despa" value="<?php if (isset($id_despa)){echo $id_despa;} ?>"/>
			...
			<td colspan="2" align="left"><?php include('../filtro/filtro_despa.php');?></td></tr>
	</table>
	</center>
    </body>
</html>