<?php
	...
	$user=$_GET['user'];
	$id=$_GET['mas'];
	$sql3="SELECT fecha FROM desparacitacion WHERE id_mascota='$id'";
	...
	$id=$_GET['mas'];
	$fecha=$_GET['fecha'];
	$sql4="SELECT actividad FROM desparacitacion WHERE fecha='$fecha' AND id_mascota='$id'";
		...
		<center>
			<table >
				<tr>
					...
					<th>
						<div class="titulo" align="center">Fechas De Desparasitaci&oacuten</div>
					</th>
				</tr>
				<tr>
					<td><br>
					...
					<td><br>
					<form action="fecha_despa.php" method="POST" name="fecha">
					<div class="styled-select">
