...
$despara="SELECT desparacitacion.id_despa,desparacitacion.fecha,desparacitacion.actividad,mascota.nombre,mascota.raza,especie.especie,
propietario.p_nombre,propietario.p_apellido,Propietario.celular,propietario.numero_tipo FROM desparacitacion,mascota,especie,propietario WHERE desparacitacion.id_mascota=mascota.id_mascota
AND mascota.id_especie=especie.id_especie AND mascota.id_propietario=propietario.id_propietario AND desparacitacion.id_despa='$id'";
...
if(isset($_POST['act']))
{
	...
	$esp=$_POST['esp'];
	$fecha=$_POST['fecha'];
	$up="UPDATE desparacitacion SET fecha='$fecha',actividad='$motivos',id_propietario='$esp' WHERE id_despa='$id'";
	...
	{
		echo '<script language="javascript">alert("Actualizado la desparacitacion");
