...
<?php
	...
	echo "</td>";
	echo "<td>";
    echo "<a href='../actualizar/act_vacunacion.php?id_reg=$fila[7]' target='proceso' ><img src='../img/edit.png' width='20' height='20' /></a>";
	echo "</td>";
	echo "<td>";
	echo "<a href='../del/del_vacunacion.php?id_reg=$fila[7]' target='proceso' onclick='return confirmar();'><img src='../img/del.gif' width='20' height='20' /></a>";
	echo "</td>";
	echo "</tr>";
   }					
?>
