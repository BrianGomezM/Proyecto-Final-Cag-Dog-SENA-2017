...
$cons="SELECT mascota.id_mascota, mascota.nombre, DATEDIFF(fecha_actu,fecha_nacimiento), mascota.color, mascota.peso_kg, mascota.raza, 
...
//mostrar todas las especies
	...
	if ($reg>0)
		{
				...
				else
				{
				  ...
				  {
							if(($fila[2]>31) && ($fila[2]<367))
							  {
								  $fila[2] = floor( $fila[2]/ 31 );
								  $tiempo= " Mes";
							  }
				  } 
	...
	echo "</td>";
	echo "<td>";
	echo "<p class='compañia' value='".$fila['1']."' name='fecha'>".$fila['2'].$tiempo."</p>";
	echo "</td>";
	echo "<td>";
...
?>
  ...
  Buscar por
  <p class="compañia">Propietario:</p><select name="pro"  onchange="document.pro.submit();">
