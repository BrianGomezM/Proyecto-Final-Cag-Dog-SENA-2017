...
$link= Conectarse();
$cons="SELECT `id_especie`,`especie` FROM `especie`";
...
<?php
	...
	echo "</td>";
	echo "<td>";
    echo "<a href='../actualizar/act_especie.php?id_reg=$fila[0]' target='proceso' ><img src='../img/edit.png' width='20' height='20' /></a>";
	echo "</td>";
	echo "<td>";
	echo "<a href='../del/del_especie.php?id_reg=$fila[0]' target='proceso' onclick='return confirmar();'>
	<img src='../img/del.gif' width='20' height='20' /></a>";
	echo "</td>";
	echo "</tr>";
   }					
?>
